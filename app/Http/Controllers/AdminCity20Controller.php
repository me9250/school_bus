<?php namespace App\Http\Controllers;
	...
	class AdminCity20Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"District","name"=>"district_id","join"=>"district,name_english"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'District','name'=>'district_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'district,name_english'];
