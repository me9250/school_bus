<?php namespace App\Http\Controllers;
	...
	class AdminStudent30Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			$(function() {
				...
				$.get('http://127.0.0.1/school_bus_managment_system/public/api/get_all_students', function(data, status){
