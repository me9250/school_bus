...
(12, 'logo', 'uploads/2019-08/b0f37067ef6fb3dec44b35d444f506cb.png', 'upload_image', NULL, NULL, '2019-08-15 07:08:11', NULL, 'Application Setting', 'Logo'),
(13, 'favicon', 'uploads/2019-08/58d42db555992d0c2ac15da5d850b2bc.png', 'upload_image', NULL, NULL, '2019-08-15 07:08:11', NULL, 'Application Setting', 'Favicon'),
...
INSERT INTO `months` (`id`, `name_english`, `name_arabic`, `month_status`) VALUES
(1, 'January', 'يناير', 'School'),
(2, 'February', 'فبراير', 'School'),
(3, 'March', 'مارس', 'School'),
(4, 'April', 'أبريل', 'School'),
(5, 'May', 'مايو', 'School'),
(6, 'June', 'يونيو', 'School'),
(7, 'July', 'يوليو', 'Vaction'),
(8, 'August', 'أغسطس', 'Vaction'),
(9, 'September', 'سبتمبر', 'School'),
(10, 'October', 'أكتوبر', 'School'),
(11, 'November', 'نوفمبر', 'School'),
(12, 'December', 'ديسمبر', 'School');
...
CREATE TABLE `month_payment` (
  ...
  `month_recipt_no` varchar(50) NOT NULL,
  `month_recipt_date` date NOT NULL,
  `month_payment_status` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `month_payment` (`id`, `month_id`, `student_id`, `year_id`, `month_fees`, `month_recipt_no`, `month_recipt_date`, `month_payment_status`) VALUES
(1, 9, 6, 1, '40', '55645', '2019-08-22', 1);
